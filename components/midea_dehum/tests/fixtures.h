...
// V1 MCU ACK capture from MAD50CIAWS-A hardware where data[7] (0x00) != data[8] (0x03)
static const uint8_t V1_REAL_MAD50_ACK[] = {
    0xAA, 0x2A, 0xA1, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x07,
